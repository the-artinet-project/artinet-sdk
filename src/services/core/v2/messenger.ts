...
export class Messenger
  extends EventEmitter<v2.a2a.MessageMap>
  implements v2.a2a.MessageProducer, v2.a2a.MessageConsumer
{
  ...
  static create(message: A2A.MessageSendParams): v2.a2a.MessageConsumerProxy {
